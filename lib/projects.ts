...
export const projects: Project[] = [
  {
    ...
    details:
      "Providing comprehensive banking services to millions of customers through an innovative and secure platform.",
  ...
  },
  {
    ...
    details:
      "Developed a secure document archiving system implementing robust security measures and efficient document management.",
